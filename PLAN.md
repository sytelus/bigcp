...
The measured directory-affinity discussion below governs local and generic-UNC
destinations. WSL destinations deliberately use the isolated inverse policy:
same-directory creates are striped across workers to cover Plan 9 round-trip
latency without changing the NTFS route (ADR 0046).
